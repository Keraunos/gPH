...
namespace axe {
    ...
    namespace detail {
        ...
        //-------------------------------------------------------------------------
        template<class T, bool = !is_rule<typename std::remove_reference<T>::type>::value
    ...
    r_and_t<
        ...
        typename std::enable_if<!is_rule<typename std::remove_reference<R2>::type>::value, 
    ...
    template<class R1, class R2>
    r_and_t<
        typename std::enable_if<is_rule<typename std::remove_reference<R1>::type>::value, 
    ...
    template<class R>
    r_many_t<
        typename std::enable_if<!is_rule<typename std::remove_reference<R>::type>::value, 
    ...
    inline r_bool_t<
        typename std::enable_if<!is_rule<typename std::remove_reference<BoolT>::type>::value, 
        BoolT>::type
    >
    ...
    template<class T>
    inline r_bin_t<
        typename std::enable_if<!is_rule<typename std::remove_reference<T>::type>::value, T>::type
    > 
    ...
    template<class T>
    inline 
        typename std::enable_if<!is_rule<typename std::remove_reference<T>::type>::value,
    ...
    template<typename T>
    inline 
        typename std::enable_if<!is_rule<typename std::remove_reference<T>::type>::value, r_char_t<T>>::type
    ...
    template<typename T>
    inline 
        typename std::enable_if<!is_rule<typename std::remove_reference<T>::type>::value, r_str_t<T>>::type
    ...
    template<class CharT, class TraitsT, class AllocT>
    inline 
        typename std::enable_if<!is_rule<typename std::remove_reference<CharT>::type>::value, 
        r_str_t<std::basic_string<CharT, TraitsT, AllocT>&>>::type
    ...
    //-------------------------------------------------------------------------
    /// r_end rule matches end of range
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    /// r_token rule matches specified token
    //-------------------------------------------------------------------------
    template<typename T>
    inline typename std::enable_if<
        !is_rule<typename std::remove_reference<T>::type>::value, r_token_t<T>
    >::type
    r_token (T&& token) 
    { 
