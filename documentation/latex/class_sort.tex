...
{\em \-Process\-Ptr} & p the process added \\
\hline
\end{DoxyParams}
...
creates pointers to sorts 


\begin{DoxyParams}{\-Parameters}
{\em string} & name of the sort you want to point at \\
\hline
{\em int} & number of processes in the sort \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{\-Returns}
\-Sort\-Ptr the \-Sort\-Ptr pointed at 
\end{DoxyReturn}
