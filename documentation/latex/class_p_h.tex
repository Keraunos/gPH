...
add an action to the \hyperlink{class_p_h}{\-P\-H} 


\begin{DoxyParams}{\-Parameters}
{\em \-Action\-Ptr} & the action added \\
\hline
\end{DoxyParams}
...
add a sort to the \hyperlink{class_p_h}{\-P\-H} 


\begin{DoxyParams}{\-Parameters}
{\em \-Sort\-Ptr} & the sort added \\
\hline
\end{DoxyParams}
...
\begin{DoxyReturn}{\-Returns}
the text representation of the process hitting in \hyperlink{class_p_h}{\-P\-H} format 
\end{DoxyReturn}
...
if it is, the default rate makes no sense 
